...
/* Theme */
:root { --sidebar-w: 220px; --primary: #6366f1; --primary-light: #818cf8; --accent: #06b6d4; --success: #22c55e; --danger: #ef4444; --warning: #f59e0b; --bg: #f0f2f6; --card: #fff; --text: #1e293b; --text2: #64748b; --border: #e2e8f0; --shadow: 0 1px 3px rgba(0,0,0,0.06), 0 1px 2px rgba(0,0,0,0.04); --shadow-lg: 0 10px 25px -5px rgba(0,0,0,0.08); --radius: 12px; --radius-sm: 8px; --transition: 0.2s ease; }
.dark { --bg: #0f172a; --card: #1e293b; --text: #f1f5f9; --text2: #94a3b8; --border: #334155; --shadow: 0 1px 3px rgba(0,0,0,0.3); --shadow-lg: 0 10px 25px -5px rgba(0,0,0,0.4); }
...
/* Sidebar */
.sidebar { width: var(--sidebar-w); background: linear-gradient(180deg, #1e1b4b 0%, #0f172a 100%); color: #e2e8f0; display: flex; flex-direction: column; position: fixed; top: 0; left: 0; bottom: 0; z-index: 100; }
.logo { padding: 1.25rem; display: flex; align-items: center; gap: 0.75rem; border-bottom: 1px solid rgba(255,255,255,0.06); }
.logo-icon { color: var(--primary-light); display: flex; }
.logo-text { font-size: 1.2rem; font-weight: 700; background: linear-gradient(135deg, #e2e8f0, #a5b4fc); -webkit-background-clip: text; -webkit-text-fill-color: transparent; }
.nav { flex: 1; padding: 0.75rem 0; }
.nav-item { display: flex; align-items: center; gap: 0.75rem; padding: 0.7rem 1.25rem; cursor: pointer; color: #94a3b8; transition: all var(--transition); font-size: 0.88rem; border-left: 3px solid transparent; }
.nav-item:hover { color: #e2e8f0; background: rgba(255,255,255,0.04); }
.nav-item.active { color: #fff; background: rgba(99,102,241,0.15); border-left-color: var(--primary-light); }
.nav-icon { font-size: 1rem; width: 20px; text-align: center; }
.sidebar-footer { padding: 1rem 1.25rem; border-top: 1px solid rgba(255,255,255,0.06); display: flex; align-items: center; justify-content: space-between; }
...
.topbar { background: var(--card); padding: 0.75rem 1.5rem; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid var(--border); position: sticky; top: 0; z-index: 50; }
...
.search-input { padding: 0.4rem 0.75rem; border: 1px solid var(--border); border-radius: var(--radius-sm); font-size: 0.85rem; background: var(--bg); color: var(--text); outline: none; width: 200px; transition: border-color var(--transition); }
...
.stat-card { background: var(--card); border-radius: var(--radius); padding: 1.25rem; display: flex; align-items: center; gap: 1rem; box-shadow: var(--shadow); transition: transform var(--transition), box-shadow var(--transition); }
.stat-card:hover { transform: translateY(-2px); box-shadow: var(--shadow-lg); }
.stat-icon { font-size: 1.5rem; width: 44px; height: 44px; display: flex; align-items: center; justify-content: center; border-radius: var(--radius-sm); }
.stat-total .stat-icon { background: #eef2ff; color: var(--primary); }
.stat-running .stat-icon { background: #f0fdf4; color: var(--success); }
.stat-stopped .stat-icon { background: #fef2f2; color: var(--danger); }
.stat-projects .stat-icon { background: #fefce8; color: var(--warning); }
.dark .stat-total .stat-icon { background: rgba(99,102,241,0.15); }
.dark .stat-running .stat-icon { background: rgba(34,197,94,0.15); }
.dark .stat-stopped .stat-icon { background: rgba(239,68,68,0.15); }
.dark .stat-projects .stat-icon { background: rgba(245,158,11,0.15); }
...
.group-header { display: flex; align-items: center; gap: 0.5rem; padding: 0.6rem 0.75rem; background: var(--card); border-radius: var(--radius); box-shadow: var(--shadow); cursor: pointer; transition: all var(--transition); }
.group-header:hover { box-shadow: var(--shadow-lg); }
...
.group-file { font-size: 0.75rem; color: var(--text2); font-family: monospace; }
...
/* Detail */
.back-btn { background: none; border: none; color: var(--primary); cursor: pointer; font-size: 0.85rem; padding: 0; margin-bottom: 0.75rem; }
.detail-hero { display: flex; align-items: center; gap: 1rem; margin-bottom: 1.25rem; padding: 1.25rem; background: var(--card); border-radius: var(--radius); box-shadow: var(--shadow); }
.detail-hero-info { flex: 1; }
.hero-tag { font-size: 0.75rem; color: var(--primary); background: rgba(99,102,241,0.1); padding: 0.1rem 0.5rem; border-radius: 4px; display: inline-block; margin-bottom: 0.25rem; }
.detail-hero h2 { font-size: 1.4rem; font-weight: 700; }
.hero-status { padding: 0.25rem 0.75rem; border-radius: 20px; font-size: 0.78rem; font-weight: 600; text-transform: uppercase; }
.hero-status.running { background: #f0fdf4; color: #16a34a; }
.hero-status.exited { background: #fef2f2; color: #dc2626; }
...
.btn { padding: 0.5rem 1rem; border: none; border-radius: var(--radius-sm); cursor: pointer; font-size: 0.82rem; font-weight: 500; transition: all var(--transition); }
.btn:hover { transform: translateY(-1px); }
.btn:disabled { opacity: 0.35; cursor: not-allowed; transform: none; }
.btn-primary { background: var(--primary); color: #fff; }
.btn-primary:hover { box-shadow: 0 4px 12px rgba(99,102,241,0.4); }
.action-start { background: #f0fdf4; color: #16a34a; }
.action-stop { background: #fef2f2; color: #dc2626; }
.action-reload { background: #eff6ff; color: #2563eb; }
.action-remove { background: #fef2f2; color: #dc2626; }
.btn-log-btn { background: #faf5ff; color: #9333ea; }
.btn-exec-btn { background: var(--primary); color: #fff; }
.btn-log-btn, .btn-exec-btn { padding: 0.4rem 0.8rem; border: none; border-radius: var(--radius-sm); cursor: pointer; font-size: 0.8rem; }
